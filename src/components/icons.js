...
export const icons = {
  ...
  map: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 1118 0z"/><circle cx="12" cy="10" r="3"/></svg>',
  ...
  chevDown: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M6 9l6 6 6-6"/></svg>',
  ...
  chevRight: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M9 18l6-6-6-6"/></svg>',
  ...
  mail: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><path d="M22 6l-10 7L2 6"/></svg>',
  mapPin: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 1118 0z"/><circle cx="12" cy="10" r="3"/></svg>',
  clock2: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>',
  ...
  award: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="8" r="7"/><path d="M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg>',
  ...
  tripadvisor: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8z"/><circle cx="8.5" cy="12" r="2.5"/><circle cx="15.5" cy="12" r="2.5"/><path d="M12 7c-3 0-5.5 1.5-7 4h2.5c1.1-1.5 2.7-2.5 4.5-2.5s3.4 1 4.5 2.5H19c-1.5-2.5-4-4-7-4z"/></svg>',
  tiktok: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005.84 20.7a6.34 6.34 0 0010-5.45V8.11a7.92 7.92 0 005 1.76z"/></svg>',
  ...
  twitter: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.24 2H22l-8.23 9.42L23.44 22h-7.61l-5.96-7.8-6.84 7.8H-1l8.77-10.02L-1.32 2h7.8l5.38 7.07zm-1.33 18.06h2.09L5.34 3.82H3.14z"/></svg>',
...
export function renderLogo(inverted = false) {
  ...
  return `<svg viewBox="0 0 260 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:220px;height:52px;direction:ltr">
    <defs>
      ...
      <linearGradient id="waveGrad${inverted?'I':''}" x1="0" y1="0" x2="80" y2="0" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stop-color="#06b6d4"/>
        <stop offset="100%" stop-color="#3b82f6"/>
      </linearGradient>
    </defs>
    <!-- Logo Mark -->
    <circle cx="28" cy="30" r="26" fill="${inverted ? 'rgba(255,255,255,0.15)' : `url(#logoGrad${inverted?'I':''})`}"/>
    <path d="M10 34 Q19 24 28 34 Q37 44 46 34" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round"/>
